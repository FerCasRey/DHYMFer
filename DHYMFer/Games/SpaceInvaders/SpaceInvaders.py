...
class Jugador(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load('Games/SpaceInvaders/img/Galaxian64.png')  # Carga la imagen
...
imagenes_enemigos = ['Games/SpaceInvaders/img/Enemy(Porpol).png', 'Games/SpaceInvaders/img/Enemy2.png', 'Games/SpaceInvaders/img/Ufo.png', 'Games/SpaceInvaders/img/Enemy(Porpol).png']
